...
public class GeneratedRepository extends ReflectionBasedRepository {
	...
	public static final MMBusinessProcessCatalogue catalogue = new MMBusinessProcessCatalogue() {
		{
			topLevelCatalogueEntry_lazy = () -> Arrays.asList(AdministrationLatestVersion.mmObject(), CashManagementLatestVersion.mmObject(), BusinessApplicationHeaderLatestVersion.mmObject(), ForeignExchangeTradeLatestVersion.mmObject(),
					ForeignExchangeTradePreviousVersion.mmObject());
	 ...
	 * topLevelDictionaryEntry} = List of 1306 elements</li>
	 * </ul>
	 */
