...
public class PartyName {
	...
	public static final MMBusinessAttribute mmName = new MMBusinessAttribute() {
		{
			derivation_lazy = () -> Arrays.asList(FinancialInstitutionIdentification8.mmName, BranchData2.mmName, ContactDetails2.mmName, IdentificationSource3Choice.mmProprietary, PartyIdentification42.mmName, NameAndAddress8.mmName,
					PartyIdentification59.mmPartyName, ContactInformation1.mmName);
			isDerived = false;
