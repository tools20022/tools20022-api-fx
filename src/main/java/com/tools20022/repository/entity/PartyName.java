...
public class PartyName {
	...
	public static final MMBusinessAttribute<PartyName, Max140Text> mmName = new MMBusinessAttribute<PartyName, Max140Text>() {
		{
			derivation_lazy = () -> Arrays.asList(FinancialInstitutionIdentification8.mmName, BranchData2.mmName, ContactDetails2.mmName, PartyIdentification.mmName, IdentificationSource1Choice.mmProprietary,
					IdentificationSource3Choice.mmProprietary, PartyIdentification42.mmName, NameAndAddress8.mmName, PartyIdentification59.mmPartyName, ContactInformation1.mmName);
			isDerived = false;
