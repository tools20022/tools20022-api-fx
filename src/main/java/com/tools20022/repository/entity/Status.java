...
public class Status {
	...
	public static final MMBusinessAttribute<Status, ISODateTime> mmStatusDateTime = new MMBusinessAttribute<Status, ISODateTime>() {
		{
			derivation_lazy = () -> Arrays.asList(TradeData11.mmCurrentStatusDateTime, TradeData14.mmCurrentStatusDateTime, TradeData12.mmCurrentStatusDateTime, TradeData15.mmCurrentStatusDateTime, TradeData15.mmPreviousStatusDateTime,
					TradeData16.mmCurrentStatusDateTime);
			isDerived = false;
			elementContext_lazy = () -> com.tools20022.repository.entity.Status.mmObject();
			registrationStatus = MMRegistrationStatus.REGISTERED;
			name = "StatusDateTime";
