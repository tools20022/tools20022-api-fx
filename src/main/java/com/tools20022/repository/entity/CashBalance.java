...
import com.tools20022.repository.msg.BalanceStatus2;
import com.tools20022.repository.msg.PayInCallItem;
import com.tools20022.repository.msg.ReportData4;
...
public class CashBalance extends Balance {
	...
	public static final MMBusinessAttribute mmAmount = new MMBusinessAttribute() {
		{
			derivation_lazy = () -> Arrays.asList(PayInCallItem.mmAmount, BalanceStatus2.mmBalance);
			isDerived = false;
			elementContext_lazy = () -> com.tools20022.repository.entity.CashBalance.mmObject();
			registrationStatus = MMRegistrationStatus.REGISTERED;
			name = "Amount";
	...
	public static final MMBusinessAssociationEnd mmCashBalanceEntry = new MMBusinessAssociationEnd() {
		{
			derivation_lazy = () -> Arrays.asList(ReportData5.mmAccountValue);
			isDerived = false;
			elementContext_lazy = () -> com.tools20022.repository.entity.CashBalance.mmObject();
			registrationStatus = MMRegistrationStatus.REGISTERED;
		...
		mmObject_lazy.compareAndSet(null, new MMBusinessComponent() {
			{
				...
				derivationComponent_lazy = () -> Arrays.asList(PayInCallItem.mmObject(), ReportData5.mmObject(), BalanceStatus2.mmObject(), ReportData4.mmObject());
			}
