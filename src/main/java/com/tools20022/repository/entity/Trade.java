...
public class Trade {
	...
	public static final MMBusinessAttribute mmTradeDateTime = new MMBusinessAttribute() {
		{
			derivation_lazy = () -> Arrays.asList(RegulatoryReporting4.mmExecutionTimestamp, TradeAgreement12.mmTradeDate, RegulatoryReporting6.mmExecutionTimestamp, RegulatoryReporting6.mmConfirmationDateAndTimestamp,
					TradeAgreement15.mmTradeDate, TradeAgreement14.mmTradeDate, FixingConditions1.mmTradeDate);
			isDerived = false;
	...
	public static final MMBusinessAttribute mmValueDate = new MMBusinessAttribute() {
		{
			derivation_lazy = () -> Arrays.asList(AmountsAndValueDate1.mmSettlementDate, TradeData11.mmCurrentSettlementDate, TradeData11.mmNewSettlementDate, RegulatoryReporting6.mmClearingTimestamp);
			isDerived = false;
			elementContext_lazy = () -> com.tools20022.repository.entity.Trade.mmObject();
			registrationStatus = MMRegistrationStatus.REGISTERED;
			name = "ValueDate";
