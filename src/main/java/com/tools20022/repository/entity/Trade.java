...
public class Trade {
	...
	public static final MMBusinessAttribute<Trade, ISODateTime> mmTradeDateTime = new MMBusinessAttribute<Trade, ISODateTime>() {
		{
			derivation_lazy = () -> Arrays.asList(RegulatoryReporting4.mmExecutionTimestamp, TradeAgreement12.mmTradeDate, Trade2.mmTradeDate, Trade1.mmDateAndTime, RegulatoryReporting6.mmExecutionTimestamp,
					RegulatoryReporting6.mmConfirmationDateAndTimestamp, TradeAgreement15.mmTradeDate, TradeAgreement14.mmTradeDate, FixingConditions1.mmTradeDate);
			isDerived = false;
	...
	public static final MMBusinessAttribute<Trade, ISODate> mmValueDate = new MMBusinessAttribute<Trade, ISODate>() {
		{
			derivation_lazy = () -> Arrays.asList(AmountsAndValueDate1.mmSettlementDate, TradeData11.mmCurrentSettlementDate, TradeData11.mmNewSettlementDate, Option10.mmValuationRate, RegulatoryReporting6.mmClearingTimestamp);
			isDerived = false;
			elementContext_lazy = () -> com.tools20022.repository.entity.Trade.mmObject();
			registrationStatus = MMRegistrationStatus.REGISTERED;
			name = "ValueDate";
	...
	public static final MMBusinessAssociationEnd<Trade, List<TradeIdentification>> mmTradeRelatedIdentifications = new MMBusinessAssociationEnd<Trade, List<TradeIdentification>>() {
		{
			derivation_lazy = () -> Arrays.asList(CounterpartySideTransactionReporting1.mmCounterpartySideUniqueTransactionIdentifier, TradingSideTransactionReporting1.mmTradingSideUniqueTransactionIdentifier,
	...
	public static final MMBusinessAttribute<Trade, Max35Text> mmAllocationIndicator = new MMBusinessAttribute<Trade, Max35Text>() {
		{
			derivation_lazy = () -> Arrays.asList(RegulatoryReporting4.mmAllocationIndicator, RegulatoryReporting6.mmAllocationIndicator);
			isDerived = false;
			elementContext_lazy = () -> com.tools20022.repository.entity.Trade.mmObject();
			registrationStatus = MMRegistrationStatus.REGISTERED;
	...
	public static final MMBusinessAttribute<Trade, Max35Text> mmCollateralisationType = new MMBusinessAttribute<Trade, Max35Text>() {
		{
			derivation_lazy = () -> Arrays.asList(RegulatoryReporting4.mmCollateralisationIndicator, RegulatoryReporting6.mmCollateralisationIndicator);
			isDerived = false;
			elementContext_lazy = () -> com.tools20022.repository.entity.Trade.mmObject();
			registrationStatus = MMRegistrationStatus.REGISTERED;
	...
	public static final MMBusinessAttribute<Trade, YesNoIndicator> mmBlockIndicator = new MMBusinessAttribute<Trade, YesNoIndicator>() {
		{
			derivation_lazy = () -> Arrays.asList(GeneralInformation5.mmBlockIndicator);
			isDerived = false;
			elementContext_lazy = () -> com.tools20022.repository.entity.Trade.mmObject();
			registrationStatus = MMRegistrationStatus.REGISTERED;
			name = "BlockIndicator";
