...
public class PartyIdentificationInformation {
	...
	public static final MMBusinessAssociationEnd<PartyIdentificationInformation, GenericIdentification> mmOtherIdentification = new MMBusinessAssociationEnd<PartyIdentificationInformation, GenericIdentification>() {
		{
			derivation_lazy = () -> Arrays.asList(PersonIdentification5.mmOther, ContactDetails2.mmOther, OrganisationIdentification7.mmOther, PartyIdentification44.mmAlternativeIdentifier);
			isDerived = false;
		...
		mmObject_lazy.compareAndSet(null, new MMBusinessComponent() {
			{
				...
				derivationElement_lazy = () -> Arrays.asList(PartyIdentification42.mmIdentification, PartyIdentification19Choice.mmNameAndAddress, PartyIdentification73Choice.mmNameAndAddress,
						PartyIdentification73Choice.mmPartyIdentification, PartyIdentification60.mmNameAndAddress);
				...
				derivationComponent_lazy = () -> Arrays.asList(PartyIdentification.mmObject(), Party10Choice.mmObject(), PartyIdentification42.mmObject(), Party9Choice.mmObject(), NameAndAddress8.mmObject(),
						PartyIdentification44.mmObject(), PartyIdentification19Choice.mmObject(), PartyIdentification59.mmObject(), PartyIdentification73Choice.mmObject(), PartyIdentification60.mmObject());
			}
