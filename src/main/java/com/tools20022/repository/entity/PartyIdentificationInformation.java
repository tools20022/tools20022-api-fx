		...
		mmObject_lazy.compareAndSet(null, new MMBusinessComponent() {
			{
				...
				derivationElement_lazy = () -> Arrays.asList(PartyIdentification42.mmIdentification, PartyIdentification73Choice.mmNameAndAddress, PartyIdentification73Choice.mmPartyIdentification, PartyIdentification60.mmNameAndAddress);
				...
				derivationComponent_lazy = () -> Arrays.asList(Party10Choice.mmObject(), PartyIdentification42.mmObject(), Party9Choice.mmObject(), NameAndAddress8.mmObject(), PartyIdentification44.mmObject(),
						PartyIdentification59.mmObject(), PartyIdentification73Choice.mmObject(), PartyIdentification60.mmObject());
			}
