...
public class GenericIdentification {
	...
	public static final MMBusinessAttribute<GenericIdentification, Max35Text> mmIdentification = new MMBusinessAttribute<GenericIdentification, Max35Text>() {
		{
			derivation_lazy = () -> Arrays.asList(GenericIdentification1.mmIdentification, ClearingSystemMemberIdentification2.mmMemberIdentification, GenericFinancialIdentification1.mmIdentification, BranchData2.mmIdentification,
					GenericOrganisationIdentification1.mmIdentification, GenericPersonIdentification1.mmIdentification, AdditionalReferences.mmReference, AlternateIdentification1.mmIdentification, OtherIdentification1.mmIdentification,
					SimpleIdentificationInformation4.mmIdentification, GenericIdentification32.mmIdentification, NameAndAddress8.mmAlternativeIdentifier, FundIdentification3.mmAccountIdentificationWithCustodian,
					FundIdentification4.mmAccountIdentificationWithCustodian, RegulatoryReporting4.mmExecutionVenue, CounterpartySideTransactionReporting1.mmReportingJurisdiction, TradingSideTransactionReporting1.mmReportingJurisdiction,
					RegulatoryReporting6.mmExecutionVenue, TradeData14.mmStatusOriginator, TradeData12.mmStatusOriginator, TradeData15.mmStatusOriginator, TradeData16.mmStatusOriginator);
			isDerived = false;
		...
		mmObject_lazy.compareAndSet(null, new MMBusinessComponent() {
			{
				...
				derivationComponent_lazy = () -> Arrays.asList(GenericIdentification1.mmObject(), AdditionalReferences.mmObject(), SimpleIdentificationInformation4.mmObject(), GenericIdentification32.mmObject());
			}
