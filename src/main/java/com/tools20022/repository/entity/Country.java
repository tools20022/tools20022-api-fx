...
public class Country {
	...
	public static final MMBusinessAttribute<Country, CountryCode> mmCode = new MMBusinessAttribute<Country, CountryCode>() {
		{
			derivation_lazy = () -> Arrays.asList(PostalAddress1.mmCountry, PostalAddress6.mmCountry, DateAndPlaceOfBirth.mmCountryOfBirth, PartyIdentification42.mmCountryOfResidence);
			isDerived = false;
			elementContext_lazy = () -> com.tools20022.repository.entity.Country.mmObject();
			registrationStatus = MMRegistrationStatus.REGISTERED;
			name = "Code";
