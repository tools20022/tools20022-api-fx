		...
		mmObject_lazy.compareAndSet(null, new MMMessageComponent() {
			{
				...
				messageBuildingBlock_lazy = () -> Arrays.asList(ForeignExchangeTradeConfirmationStatusAdviceV01.mmAdviceIdentification, ForeignExchangeTradeConfirmationRequestCancellationRequestV01.mmCancellationRequestIdentification,
						ForeignExchangeTradeConfirmationRequestAmendmentRequestV01.mmAmendmentRequestIdentification, ForeignExchangeTradeConfirmationStatusAdviceAcknowledgementV01.mmAdviceAcknowledgementIdentification,
						ForeignExchangeTradeConfirmationStatusAdviceAcknowledgementV01.mmRequestIdentification, ForeignExchangeTradeConfirmationRequestV01.mmRequestIdentification,
						ForeignExchangeTradeCaptureReportRequestV01.mmQueryRequestIdentification, ForeignExchangeTradeCaptureReportV01.mmReportIdentification,
						ForeignExchangeTradeCaptureReportAcknowledgementV01.mmAcknowledgementIdentification);
